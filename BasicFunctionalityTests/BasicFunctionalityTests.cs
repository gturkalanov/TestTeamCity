using BasicFunctionalityTests.Pages.ArticleDeletePage;
using BasicFunctionalityTests.Pages.ArticleDetailsPage;
using BasicFunctionalityTests.Pages.ArticleEditPage;
using BasicFunctionalityTests.Pages.ChangePasswordPage;
using BasicFunctionalityTests.Pages.CreatePage;
using BasicFunctionalityTests.Pages.LoginPage;
using BasicFunctionalityTests.Pages.ManagePage;
using BasicFunctionalityTests.Pages.RegistrationPage;
using BasicFunctionalityTests.Pages.UserListPage;
using NUnit.Framework;
using NUnit.Framework.Interfaces;
using OpenQA.Selenium;
using OpenQA.Selenium.Chrome;
using BasicFunctionalityTests.Pages.HomePage;
using System;
